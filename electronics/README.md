...
Alimentazione Analogica:
  V_IN (+12V o +5V da Nucleo) -> LDO (+5V Analogico) -> Pompa LTC1144 -> Tensione Negativa (-5V Analogico)

Trasmissione (TX - 1 MHz):
  Nucleo H7 TIM1 (PE9, PE11) -> Gate Driver MAX4427CPA+ -> Ponte MOSFET -> 2x Piezo 1 MHz

Ricezione (RX AFE) e Acquisizione:
  Piezo 1 MHz -> T/R Switch -> VGA AD600JNZ (TVG pilotato da DAC MCU PA4/PA5) -> ADC duale parallelo AD9226 (12-bit) -> Nucleo H7 GPIO Port D & E (DMA su trigger TIM2)

---

## Dettaglio Circuitale e Componenti Selezionati
