...
```
                  ...
                  ┌──────────────────────▼───────────────────────┐
                  │               Tubo Pressione                 │
                  │   (Alloggiamento Shield Nucleo + Elettronica)│
                  └──────────────────────┬───────────────────────┘
                                         │
                                 [Doppio O-Ring]
                                         │
                  ┌──────────────────────▼───────────────────────┐
                  │               Testata Janus 2D               │
                  │ (2 Trasduttori piezo da 1 MHz inclinati a 30°)│
                  └──────────────────────────────────────────────┘
```
...
- **Geometria**: Ospita 2 trasduttori piezoelettrici da **1 MHz** orientati a **30 gradi rispetto all'asse centrale** (verticale) del DVL.
  - Il Trasduttore 1 è inclinato a +30° (in avanti) per misurare la componente anteriore.
  - Il Trasduttore 2 è inclinato a -30° (all'indietro) per misurare la componente posteriore.
...
- **Incapsulamento & Matching Layer a 1 MHz**: 
