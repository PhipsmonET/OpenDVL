...
| Porta MCU H7 | Bit di Porta | Pin Nucleo Morpho | Collegamento ADC AD9226 | Descrizione |
| :--- | :--- | :--- | :--- | :--- |
| **PORTD** | `PD0` - `PD11` | CN10 (varie posizioni) | **Ch A D0 - D11** | Bus parallelo 12-bit Canale A (Trasduttore 1) |
| **PORTE** | `PE0` - `PE11` | CN9 (varie posizioni) | **Ch B D0 - D11** | Bus parallelo 12-bit Canale B (Trasduttore 2) |
| **PA8** | `MCO1` o `TIM8_CH1`| CN10-30 | **ADC_CLK** | Segnale di clock per entrambi gli ADC AD9226 (10-20 MHz) |
...
| Pin MCU H7 | Funzione Alternata | Pin Nucleo Morpho | Collegamento MAX4427 | Descrizione / Uso |
| :--- | :--- | :--- | :--- | :--- |
| **PE9** | `TIM1_CH1` | CN9-31 | **INA (Pin 2)** | Ingresso A - Comando TX 1 MHz per Canale 1 (Trasduttore 1) |
| **PE11** | `TIM1_CH2` | CN9-30 | **INB (Pin 4)** | Ingresso B - Comando TX 1 MHz per Canale 2 (Trasduttore 2) |
...
| Pin MCU H7 | Funzione Principale | Pin Nucleo Morpho | Collegamento AD600JNZ | Descrizione |
| :--- | :--- | :--- | :--- | :--- |
| **PA4** | `DAC1_OUT1` | CN10-29 | **V_G1 (Gain Control 1)** | Tensione TVG per canale RX 1 (Trasduttore 1) |
| **PA5** | `DAC1_OUT2` | CN10-11 | **V_G2 (Gain Control 2)** | Tensione TVG per canale RX 2 (Trasduttore 2) |
...
- **SHDN (Pin 3)**: Collegato a **PC4** (CN10-34). Impostando PC4 a HIGH, l'inverter LTC1144 si spegne (Shutdown mode) azzerando il consumo di corrente e le commutazioni capacitive durante i periodi di stand-by tra i pings acustici.
